...
import figure.model.DatabaseProxy;
...
public class GlavniProzor extends javax.swing.JFrame {
    ...
    private void populate() {
        ArrayList<Tacka2D> podaci = dbp.getTacka2D();
        DefaultTableModel dtm = new DefaultTableModel();
        dtm.addColumn("Oznaka");
        dtm.addColumn("X");
        dtm.addColumn("Y");
        for(Tacka2D t : podaci){
